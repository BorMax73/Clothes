...
namespace Admin
{
    public class ProductImagesController : Controller
    {
        ...
        public ProductImagesController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationContext = _context.ProductImages.Include(p => p.Product);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "Brand", productImage.ProductId);
            return View(productImage);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationContext.ProductImages'  is null.");
            }
            var productImage = await _context.ProductImages.FindAsync(id);
            if (productImage != null)
            {
